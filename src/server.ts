...
import { registerExpandedApiTools } from "./tools/api.js";
import { registerApiCallTools } from "./tools/api-call.js";
...
export function createServer(config: Y2McpConfig): McpServer {
	...
	registerExpandedApiTools(server, client, config);
	registerApiCallTools(server, client, config);
